      ...
      <div className="bg-white/60 backdrop-blur-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center gap-8 py-4">
            <a href="/my-subscription" className="flex items-center text-purple-700 font-medium">
              <Gem className="w-5 h-5 mr-2" />
              My Subscription
            </a>
            <a href="/my-arts" className="flex items-center text-gray-600 hover:text-purple-700">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border p-6">
            ...
            <div className="mt-6">
              <p className="text-2xl font-bold text-purple-700">Free Plan</p>
          ...
          <div className="bg-white rounded-xl shadow-sm border p-6">
            ...
            <div className="mt-6">
              <p className="text-xl font-medium text-gray-900">
                Total Credits: <span className="font-bold text-blue-700">2</span>
              </p>
        ...
        <div className="mt-10 bg-white rounded-xl shadow-sm border">
          ...
          <div className="px-6 py-6 text-sm text-gray-600 border-t">
            ...
            {" "}
            <a href="mailto:eric@imageprompt.org" className="text-blue-600 hover:underline">
              eric@imageprompt.org
            </a>
          </div>
        </div>
      </div>
